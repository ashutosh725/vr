          ...
          <div className="flex  gap-20">
            <div className="lg:w-[50%] flex justify-center items-center lg:justify-start lg:items-start w-full xl:ml-40">
              ...
              >
                ...
                <div className="bg-[#FF00B8] cursor-pointer mt-4 rounded-[6px] uppercase w-full text-center tracking-wider font-Poppins font-bold text-[16px] py-2 px-4">
                ...
                <span className="absolute -top-5 bg-white shadow-md gap-5 font-Poppins flex justify-start items-center text-center md:font-medium text-[12px] uppercase tracking-widest rounded-md px-[10px] py-[6px] text-primary">
          ...
          <div className="bottom_btns_main flex flex-col gap-2 pt-12">
            ...
            <div className="banner_bottom_btn flex flex-col lg:flex-row  justify-center  gap-4 lg:items-end  items-center mx-4 md:mx-0 ">
              <div className="flex flex-row  justify-center items-center gap-4">
                <div
                  className="flex  md:w-[350px]  lg:w-[210px] 2xl:w-[350px] w-[150px] md:h-[70px] xl:h-[50px] 2xl:h-[70px]  h-[35px] justify-center items-center cursor-pointer  rounded-md"
                  style={{
                    background: "#FF0091",
                    transform: "skew(-35deg)",
                    OTransform: "skew(-35deg)",
                ...
                >
                  ...
                  <GoDotFill
                    className="text-[#E2FF46]  md:text-[35px] text-[16px]"
                    style={{
                      transform: "skew(35deg)", // Opposite skew to keep text straight
                      OTransform: "skew(35deg)",
                      MozTransform: "skew(35deg)",
                ...
                <div
                  className="flex md:w-[350px] lg:w-[210px] 2xl:w-[350px] w-[150px] md:h-[70px] xl:h-[50px] 2xl:h-[70px] h-[35px]  justify-center items-center gap-2 cursor-pointer rounded-md"
                  style={{
                    background: "#FF0091",
                    transform: "skew(-35deg)",
                    OTransform: "skew(-35deg)",
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-4">
                <div
                  className="offers_running_text flex xl:w-[650px] md:w-[450px] lg:w-[360px] h-[38px] justify-center items-center cursor-pointer  rounded-md"
                  style={{
                    background: "#761AC2",
                    transform: "skew(-35deg)",
                    OTransform: "skew(-35deg)",
